...
sidebarMenu(
  ...
  div(
    ...
    menuItem(
      div(icon("fas fa-database"), HTML('&nbsp;'), "Data Bank", style = "margin-left: -8px; color: white; font-size: 14px; margin-top: -2px;margin-bottom: -2px;white-space: normal;"),
      tabName = "menu_upload"
    ),
    menuItem(
...
fluidPage(
  ...
  div(
    ...
    column(12,
           splitLayout(cellWidths = c("88%","12%"),
                       uiOutput("menutitle"),
                       div(actionButton("savepoints_button",strong("Savepoints"),style="font-size: 10px; background: SeaGreen; color: white", icon=icon("fas fa-download"))))),
    tabsetPanel(
      type = "hidden",
      tabPanel("intro",
               tabItems(
...
req(isFALSE(input$stack_scatter_3d))}
  ...
  gettitle<-reactive({
    column(12,style="color: #05668D",
           if(input$tabs=="menu_intro"){h4(strong("Introduction"))} else if(input$tabs=="menu_upload"){h4(strong("Data Bank", pophelp(NULL,"Create, manage and download datalists and their associated results")))} else if(input$tabs=="menu_explore"){h4(strong("Pre-processing & Descriptive tools", pophelp(NULL,"Explore and modify data along boxplots, histograms and classic ordination techniques")))} else if(input$tabs=="menu_som"){
             ...
             } else if(input$tabs=="menu_maps"){h4(strong("Spatial tools")
                                                   )} else if(input$tabs=="menu_box"){h4(strong("Box plots"))} else if(input$tabs=="menu_div"){ h4( strong("Biological diversity indices"))} else if(input$tabs=="menu_down"){h4(strong("Download Center"))} else if(input$tabs=="menu_data"){h4(strong("Data bank"))} else if(input$tabs=="menu_dt"){h4(strong("Decision Tree"),actionLink(
...
observeEvent(input$data_upload,{
  ...
  output$menu_bank_out<-renderUI({
    column(12, style="margin-left: 5px",
           uiOutput("bank_tools"),
           uiOutput("view_out"))
  })
  ...
  output$stats_attributes<-renderUI({
    ...
    splitLayout(cellWidths = c("90%","10%"),
      ...
      bsPopover("002",NULL,"Factor-Attribute"),
             ...
             splitLayout(
               ...
               h5(
                 ...
                 dropdownButton(icon=icon("fas fa-edit"),
                                status ="button_active" ,  inline = T, circle=F,tooltip = tooltipOptions(title = "Select and remove a factor", placement="bottom"),
                                div(
                                  splitLayout(cellWidths = c("30%","10%"),
  ...
  output$viewcoords<-renderUI({
    if(is.null(attr(getdata_bank(),"coords"))) {
      ...
      fluidRow(
        h5(strong("Coords-Attribute"),tipify(actionButton("downcenter_coords",icon("fas fa-download")),"Download table"),
...
bag_hc<-reactive({
  ...
  setBookmarkExclude(c("savepoints_button","bank_button","layer_back","base_back","shp_back","up_or_ex","upload_insert","filedata"))
    ...
    modalDialog(
      column(12,
             splitLayout(
               ...
               numericInput("fwidth", "Width (cm)", min=2, max=15, step=1, value = 15),
